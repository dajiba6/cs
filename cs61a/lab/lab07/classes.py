...
class ProfessorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        >>> professor_test = ProfessorCard('Professor', 300, 300)
        ...
        cute_cards = opponent.deck.cards
        for card in cute_cards:
            if (
                card.attack == opponent_card.attack
                or card.defense == opponent_card.defense
            ):
